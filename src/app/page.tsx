...
const HomePage = () => {
    return (
        <div className="home min-h-screen flex items-center justify-center bg-cover bg-center relative" style={{ backgroundImage: "url('/background.jpg')" }}>
            ...
            {/* Content Section */}
            <div className="relative z-10 flex flex-col items-center p-6 sm:p-8 bg-white bg-opacity-90 rounded-lg shadow-2xl max-w-3xl mx-auto text-center">
                {/* Profile Image */}
                <Image 
                    src="/ah.jpeg" 
                    ...
                    width={150} 
                    height={150}  
                    className="rounded-full mb-6 shadow-lg border-4 border-gray-300 w-32 h-32 sm:w-40 sm:h-40"
                />
                
                {/* Intro */}
                <h3 className="text-lg font-medium text-gray-600 uppercase tracking-wide">Hello, I am</h3>
                <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mt-2 mb-4">Ameer Hamza Memon</h1>
